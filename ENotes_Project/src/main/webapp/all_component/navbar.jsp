...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0" action="serchServlet"
			method="post">
			<input class="form-control mr-sm-2" type="search"
				placeholder="Notes Search" aria-label="Search" name="ch"> <input
				type="hidden" value="<%=user.getId()%>" name="uid">
			<button class="btn btn-light my-2 my-sm-0 mr-4" type="submit">Search</button>
		</form>
